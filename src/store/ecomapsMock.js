const ecoMaps = [
  {
    ...
    description: 'Helsinki is a hotbed for innovations, the startup ecosystem is rich and well-connected and this is particularly true for health and life sciences startups.\n' +
        '\n' +
        'The fastest-growing industries in the region are health and neurotechnologies. The University of Helsinki,' +
        ' Aalto University and the City of Helsinki set a common goal in 2016 to develop the region into the best Northern European hub for life science, health-related innovations and business development. Numbers of organisations, hubs and accelerators are dedicated to the health sector. Players such as Health Capital Helsinki, Terkko Health Hub and Upgraded contribute to strengthen the connection within the ecosystem, accelerate innovations and attract foreign investments and companies to partner. Helsinki’s trust-based atmosphere allows collaboration between the public and the private sector to run smoothly. Authorities also approach the private sector for researches, drug development and patient care. Many of the largest pharma companies in the world, including Bayer, Takeda, MSD, Pfizer, and AstraZeneca, have all established a presence in Greater Helsinki. The city has a lot to offer in terms of research and development: funding opportunities, a great infrastructure, testbeds and data banks. Finland is one of the few countries in the world that has developed a nationwide network of biobanks. Key research sectors in the area include oncology, ageing, neurotechnology, food chain and microbiome.',
    mapId: '36474'
  },
  {
    cityName: 'Turku',
  ...
  },
  {
    ...
    description: 'Skåne is the southernmost province of Sweden and comprises the cities of Malmö, Helsingborg and Lund.\n' +
  ...
  },
  {
    ...
    description: 'Greater Copenhagen is part of the transnational Øresund Region, which also comprises Skåne in Sweden.\n' +
        '\n' +
        '\n' +
  ...
  },
  {
    ...
    description: 'Second best producer per capita in the world after Silicon Valley, Stockholm has the reputation of being a unicorn factory.\n' +
        '\n' +
  ...
  },
  {
    ...
    description: 'Life-science is one of Gothenburg fastest-growing industries.\n' +
        '\n' +
